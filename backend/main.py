...
def calcular_caida_libre(altura_inicial, tiempo_total_simulacion=None, num_puntos=100):
    ...
    return tiempos_reales, alturas_reales, velocidades_reales, tiempo_total_simulacion
...
def calcular_tiro_parabolico(velocidad_inicial, angulo_lanzamiento_grados, altura_inicial=0, num_puntos=100):
    ...
    return tiempos_reales, x_reales, y_reales, tiempo_total_simulacion
...
def sim_caida_libre():
    ...
    tiempos, alturas, velocidades, tiempo_total_simulacion_calculado = calcular_caida_libre(altura_inicial)
    ...
    return jsonify({
        ...
        "resultados": {
            ...
            "tiempo_total_simulacion_s": tiempo_total_simulacion_calculado,
            "posiciones": [{
                "tiempo": t,
                "y": h
            } for t, h in zip(tiempos, alturas)]
        }
    })
...
def sim_tiro_parabolico():
    ...
    tiempos, posiciones_x, posiciones_y, tiempo_total_simulacion_calculado = calcular_tiro_parabolico(velocidad_inicial, angulo_lanzamiento, altura_inicial)
    ...
    return jsonify({
        ...
        "resultados": {
            ...
            "posiciones": [{
                ...
                "x": x,
                "y": y
            } for t, x, y in zip(tiempos, posiciones_x, posiciones_y)]
        }
    })
        ...
        if p <= longitud_plano:
            ...
            if not pos_reales or pos_reales[-1] < longitud_plano:
                ...
                if tiempo_impacto_real > (tiempos_reales[-1] if tiempos_reales else 0):
                    ...
                    tiempos_reales.append(tiempo_impacto_real)
            break
    return tiempos_reales, pos_reales, vel_reales, tiempo_total_simulacion
...
def sim_plano_inclinado():
    ...
    tiempos, posiciones, velocidades, tiempo_total_simulacion_calculado = calcular_plano_inclinado(angulo_inclinacion, longitud_plano, coeficiente_friccion, masa)
...
def calcular_colision_elastica_1d(m1, v1_inicial, m2, v2_inicial):
    ...
    tiempo_total_simulacion = 0 # No hay un concepto de tiempo de simulación en colisiones instantáneas
    return v1_final, v2_final, tiempo_total_simulacion
...
def sim_colision_elastica_1d():
    ...
    v1_final, v2_final, tiempo_total_simulacion = calcular_colision_elastica_1d(m1, v1_inicial, m2, v2_inicial)
    ...
    return jsonify({
        ...
        "tiempo_total_simulacion_s": tiempo_total_simulacion,
        "posiciones": [
        {"tiempo": 0, "objeto1_x": -10, "objeto2_x": 0},
        {"tiempo": 0.1, "objeto1_x": -10 + v1_inicial * 0.1, "objeto2_x": 0 + v2_inicial * 0.1},
        {"tiempo": 0.2, "objeto1_x": -10 + v1_inicial * 0.2, "objeto2_x": 0 + v2_inicial * 0.2},
        {"tiempo": 0.3, "objeto1_x": -10 + v1_inicial * 0.3, "objeto2_x": 0 + v2_inicial * 0.3},
        {"tiempo": 0.4, "objeto1_x": -10 + v1_inicial * 0.4, "objeto2_x": 0 + v2_inicial * 0.4},
        {"tiempo": 0.5, "objeto1_x": -10 + v1_final * 0.5, "objeto2_x": 0 + v2_final * 0.5},
        {"tiempo": 0.6, "objeto1_x": -10 + v1_final * 0.6, "objeto2_x": 0 + v2_final * 0.6},
        {"tiempo": 0.7, "objeto1_x": -10 + v1_final * 0.7, "objeto2_x": 0 + v2_final * 0.7},
        {"tiempo": 0.8, "objeto1_x": -10 + v1_final * 0.8, "objeto2_x": 0 + v2_final * 0.8},
        {"tiempo": 0.9, "objeto1_x": -10 + v1_final * 0.9, "objeto2_x": 0 + v2_final * 0.9},
        {"tiempo": 1.0, "objeto1_x": -10 + v1_final * 1.0, "objeto2_x": 0 + v2_final * 1.0}
    ]
})
...
def calcular_colision_perfectamente_inelastica_1d(m1, v1_inicial, m2, v2_inicial):
    ...
    tiempo_total_simulacion = 0 # No hay un concepto de tiempo de simulación en colisiones instantáneas
    return v_final_comun, tiempo_total_simulacion
...
def sim_colision_perfectamente_inelastica_1d():
    ...
    try:
        ...
        v_final_comun, tiempo_total_simulacion = calcular_colision_perfectamente_inelastica_1d(m1, v1_inicial, m2, v2_inicial)
    ...
    "posiciones": [
        ...
        {"tiempo": 0.3, "objeto1_x": -10 + v1_inicial * 0.3, "objeto2_x": 0 + v2_inicial * 0.3},
        {"tiempo": 0.4, "objeto1_x": -10 + v1_inicial * 0.4, "objeto2_x": 0 + v2_inicial * 0.4},
        {"tiempo": 0.5, "objeto1_x": -10 + v_final_comun * 0.5, "objeto2_x": 0 + v_final_comun * 0.5},
        {"tiempo": 0.6, "objeto1_x": -10 + v_final_comun * 0.6, "objeto2_x": 0 + v_final_comun * 0.6},
        {"tiempo": 0.7, "objeto1_x": -10 + v_final_comun * 0.7, "objeto2_x": 0 + v_final_comun * 0.7},
        {"tiempo": 0.8, "objeto1_x": -10 + v_final_comun * 0.8, "objeto2_x": 0 + v_final_comun * 0.8},
        {"tiempo": 0.9, "objeto1_x": -10 + v_final_comun * 0.9, "objeto2_x": 0 + v_final_comun * 0.9},
        {"tiempo": 1.0, "objeto1_x": -10 + v_final_comun * 1.0, "objeto2_x": 0 + v_final_comun * 1.0}
    ]
})
...
def calcular_movimiento_circular_uniforme(radio, velocidad_angular=None, velocidad_tangencial=None, tiempo_total_simulacion=None, num_puntos=100):
    ...
    return list(tiempos), list(angulos_rad), list(posiciones_x), list(posiciones_y), aceleracion_centripeta, tiempo_total_simulacion
...
def sim_movimiento_circular_uniforme():
    ...
    try:
        ...
        tiempos, angulos, xs, ys, ac, tiempo_total_simulacion = calcular_movimiento_circular_uniforme(radio, v_ang, v_tan, t_total)
    ...
    return jsonify({
        ...
        "posiciones": [{
            ...
            "x": x,
            "y": y
        } for t, x, y in zip(tiempos, xs, ys)]
    }
)
